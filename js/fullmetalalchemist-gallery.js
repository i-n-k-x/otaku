/**
 * SISTEMA FULLMETAL ALCHEMIST GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Fullmetal Alchemist
 */
class FullmetalAlchemistGallery {
    constructor() {
        // Lista de imagens do Fullmetal Alchemist
        this.images = [
            "https://i.ibb.co/tMDNnCcq/f-1.jpg",
            "https://i.ibb.co/TxwdqRzF/f-2.jpg",
            "https://i.ibb.co/2050dnKm/f-3.jpg",
            "https://i.ibb.co/MDdmGLzy/f-4.jpg",
            "https://i.ibb.co/LDPT4GcT/f-5.jpg",
            "https://i.ibb.co/VWjmYMRz/f-6.jpg",
            "https://i.ibb.co/SD10NNXP/f-7.jpg",
            "https://i.ibb.co/Nn611Jnj/f-8.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando FullmetalAlchemistGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando FullmetalAlchemistGallery...');
        ...
        console.log('FullmetalAlchemistGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Fullmetal Alchemist - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `⚗️ Olá! Quero esta placa do Fullmetal Alchemist (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO FULLMETAL ALCHEMIST
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('fullmetalalchemist.html')) {
        console.log('Página de gallery Fullmetal Alchemist detectada - inicializando...');
        const fullmetalAlchemistGallery = new FullmetalAlchemistGallery();
    }
});