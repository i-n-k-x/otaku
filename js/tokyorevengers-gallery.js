/**
 * SISTEMA TOKYO REVENGERS GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
...
class TokyoRevengersGallery {
    constructor() {
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando TokyoRevengersGallery');
            return;
        }
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🏍️ Olá! Quero esta placa do Tokyo Revengers (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO TOKYO REVENGERS
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('tokyorevengers.html')) {
        console.log('Página de gallery Tokyo Revengers detectada - inicializando...');
