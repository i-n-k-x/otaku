/**
 * SISTEMA MY HERO ACADEMIA GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime My Hero Academia
 */
class MyHeroAcademiaGallery {
    constructor() {
        // Lista de imagens do My Hero Academia
        this.images = [
            "https://i.ibb.co/Lh89bw39/BNH-1.jpg",
            "https://i.ibb.co/xSVHtFkD/BNH-2.jpg",
            "https://i.ibb.co/Jjk3hCj5/BNH-3.jpg",
            "https://i.ibb.co/HTnhsZFV/BNH-4.jpg",
            "https://i.ibb.co/XfpZfTRN/BNH-5.jpg",
            "https://i.ibb.co/tpSpyJrv/BNH-6.jpg",
            "https://i.ibb.co/vxWrrgsN/BNH-7.jpg",
            "https://i.ibb.co/TBH6SSzr/BNH-8.jpg",
            "https://i.ibb.co/DHqmVfXG/BNH-9.jpg",
            "https://i.ibb.co/dRr6XyF/BNH-10.jpg",
            "https://i.ibb.co/8Dv76zZq/BNH-11.jpg",
            "https://i.ibb.co/G4PsFHt0/BNH-12.jpg",
            "https://i.ibb.co/96gVLNP/BNH-14.jpg",
            "https://i.ibb.co/nswNCzwS/BNH-13.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando MyHeroAcademiaGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando MyHeroAcademiaGallery...');
        ...
        console.log('MyHeroAcademiaGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `My Hero Academia - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `💥 Olá! Quero esta placa do My Hero Academia (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO MY HERO ACADEMIA
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('myheroacademia.html')) {
        console.log('Página de gallery My Hero Academia detectada - inicializando...');
        const myHeroAcademiaGallery = new MyHeroAcademiaGallery();
    }
});