/**
 * SISTEMA SWORD ART ONLINE GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Sword Art Online
 */
class SwordArtOnlineGallery {
    constructor() {
        // Lista de imagens do Sword Art Online
        this.images = [
            "https://i.ibb.co/9kMPPgRQ/sao-1.jpg",
            "https://i.ibb.co/0yTxZRNH/sao-2.jpg",
            "https://i.ibb.co/ch47bYSX/sao-3.jpg",
            "https://i.ibb.co/jP4Hj52M/sao-4.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando SwordArtOnlineGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando SwordArtOnlineGallery...');
        ...
        console.log('SwordArtOnlineGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Sword Art Online - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `⚔️ Olá! Quero esta placa do Sword Art Online (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO SWORD ART ONLINE
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('swordartonline.html')) {
        console.log('Página de gallery Sword Art Online detectada - inicializando...');
        const swordArtOnlineGallery = new SwordArtOnlineGallery();
    }
});