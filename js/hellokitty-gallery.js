/**
 * SISTEMA HELLO KITTY GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para a Hello Kitty
 */
class HelloKittyGallery {
    constructor() {
        // Lista de imagens da Hello Kitty
        this.images = [
            "https://i.ibb.co/h19KNf8x/HK-1.jpg",
            "https://i.ibb.co/M5JfN3pC/HK-2.jpg",
            "https://i.ibb.co/VpVvyjnS/HK-3.jpg",
            "https://i.ibb.co/HfHBPGPh/HK-4.jpg",
            "https://i.ibb.co/nsZ8FP1x/HK-5.jpg",
            "https://i.ibb.co/NdS6hG3W/HK-6.jpg",
            "https://i.ibb.co/MxPdXB0j/HK-7.jpg",
            "https://i.ibb.co/C5wgGkwY/HK-8.jpg",
            "https://i.ibb.co/CKvqXHHQ/HK-9.jpg",
            "https://i.ibb.co/tpwjQPgP/HK-10.jpg",
            "https://i.ibb.co/366kKSj/HK-11.jpg",
            "https://i.ibb.co/RT3SfLvb/HK-12.jpg",
            "https://i.ibb.co/XZvbTFdK/HK-13.jpg",
            "https://i.ibb.co/BVnyHN5H/HK-14.jpg",
            "https://i.ibb.co/5gv28t2W/HK-15.jpg",
            "https://i.ibb.co/4nRkrnwk/HK-16.jpg",
            "https://i.ibb.co/1Gjfqsfh/HK-17.jpg",
            "https://i.ibb.co/jZ8cK0cR/HK-18.jpg",
            "https://i.ibb.co/Z1gbZGL7/HK-19.jpg",
            "https://i.ibb.co/4ZPDXz28/HK-20.jpg",
            "https://i.ibb.co/XrpzybP4/HK-21.jpg",
            "https://i.ibb.co/BVfNKxsW/HK-22.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando HelloKittyGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando HelloKittyGallery...');
        ...
        console.log('HelloKittyGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Hello Kitty - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🎀 Olá! Quero esta placa da Hello Kitty (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DA HELLO KITTY
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('hellokitty.html')) {
        console.log('Página de gallery Hello Kitty detectada - inicializando...');
        const helloKittyGallery = new HelloKittyGallery();
    }
});