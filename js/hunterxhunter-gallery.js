/**
 * SISTEMA HUNTER X HUNTER GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Hunter x Hunter
 */
class HunterXHunterGallery {
    constructor() {
        // Lista de imagens do Hunter x Hunter
        this.images = [
            "https://i.ibb.co/fVHHjd9M/h1.jpg",
            "https://i.ibb.co/gMHfhTbm/h2.jpg",
            "https://i.ibb.co/9986LWqr/h3.jpg",
            "https://i.ibb.co/60mDdR3F/h4.jpg",
            "https://i.ibb.co/35KdQTPx/h5.jpg",
            "https://i.ibb.co/mCkNSfRL/h6.jpg",
            "https://i.ibb.co/7NpY9TbP/h7.jpg",
            "https://i.ibb.co/LX8vPrZP/h8.jpg",
            "https://i.ibb.co/PsXvN9GM/h9.jpg",
            "https://i.ibb.co/rR19zcHT/h10.jpg",
            "https://i.ibb.co/r12fnSm/h11.jpg",
            "https://i.ibb.co/ZzRPyNdP/h12.jpg",
            "https://i.ibb.co/8gWTQ4Ns/h13.jpg",
            "https://i.ibb.co/9HbSc5Bc/h14.jpg",
            "https://i.ibb.co/twvC4JnG/h15.jpg",
            "https://i.ibb.co/pjRVnXbY/h16.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando HunterXHunterGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando HunterXHunterGallery...');
        ...
        console.log('HunterXHunterGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Hunter x Hunter - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🎯 Olá! Quero esta placa do Hunter x Hunter (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO HUNTER X HUNTER
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('hunterxhunter.html')) {
        console.log('Página de gallery Hunter x Hunter detectada - inicializando...');
        const hunterXHunterGallery = new HunterXHunterGallery();
    }
});