/**
 * SISTEMA CHAINSAW MAN GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Chainsaw Man
 */
class ChainsawManGallery {
    constructor() {
        // Lista de imagens do Chainsaw Man
        this.images = [
            "https://i.ibb.co/kgYYLPTj/01.jpg",
            "https://i.ibb.co/R4pZ5svz/02.jpg",
            "https://i.ibb.co/hFCjmK8w/03.jpg",
            "https://i.ibb.co/ks0cdNZJ/04.jpg",
            "https://i.ibb.co/ymhYr4bD/05.jpg",
            "https://i.ibb.co/G3ctmF8W/06.jpg",
            "https://i.ibb.co/ffNSzzF/07.jpg",
            "https://i.ibb.co/5WHCgnNK/08.jpg",
            "https://i.ibb.co/MxqjRRxQ/09.jpg",
            "https://i.ibb.co/Q3F77Msz/10.jpg",
            "https://i.ibb.co/x83BL0DV/11.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando ChainsawManGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando ChainsawManGallery...');
        ...
        console.log('ChainsawManGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Chainsaw Man - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🪚 Olá! Quero esta placa do Chainsaw Man (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO CHAINSAW MAN
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('chainsawman.html')) {
        console.log('Página de gallery Chainsaw Man detectada - inicializando...');
        const chainsawManGallery = new ChainsawManGallery();
    }
});