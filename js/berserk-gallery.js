/**
 * SISTEMA BERSERK GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Berserk
 */
class BerserkGallery {
    constructor() {
        // Lista de imagens do Berserk
        this.images = [
            "https://i.ibb.co/sv30DCZS/01.jpg",
            "https://i.ibb.co/s9Z2QN9N/02.jpg",
            "https://i.ibb.co/6JDrWKHV/03.jpg",
            "https://i.ibb.co/gLV3Vsk8/04.jpg",
            "https://i.ibb.co/q3Qs020q/05.jpg",
            "https://i.ibb.co/zWxQGcq6/06.jpg",
            "https://i.ibb.co/0jkpygVC/07.jpg",
            "https://i.ibb.co/JW8ZMfpb/08.jpg",
            "https://i.ibb.co/2Yq4NcgG/09.jpg",
            "https://i.ibb.co/LzgfPBRr/10.jpg",
            "https://i.ibb.co/FdrLtNv/11.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando BerserkGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando BerserkGallery...');
        ...
        console.log('BerserkGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Berserk - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `⚔️ Olá! Quero esta placa do Berserk (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO BERSERK
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('berserk.html')) {
        console.log('Página de gallery Berserk detectada - inicializando...');
        const berserkGallery = new BerserkGallery();
    }
});
