/**
 * SISTEMA DANDADAN GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime DanDaDan
 */
class DanDaDanGallery {
    constructor() {
        // Lista de imagens do DanDaDan
        this.images = [
            "https://i.ibb.co/Xr1CTwkj/1.jpg",
            "https://i.ibb.co/jPdys5xW/2.jpg",
            "https://i.ibb.co/K4mxGk1/3.jpg",
            "https://i.ibb.co/PzgSLqyZ/4.jpg",
            "https://i.ibb.co/3mvHztk0/5.jpg",
            "https://i.ibb.co/DFnQcJM/6.jpg",
            "https://i.ibb.co/0jwZ7Cj9/7.jpg",
            "https://i.ibb.co/23y09FjV/8.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando DanDaDanGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando DanDaDanGallery...');
        ...
        console.log('DanDaDanGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `DanDaDan - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `👻 Olá! Quero esta placa do DanDaDan (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO DANDADAN
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('dandadan.html')) {
        console.log('Página de gallery DanDaDan detectada - inicializando...');
        const danDaDanGallery = new DanDaDanGallery();
    }
});