/**
 * SISTEMA ATTACK ON TITAN GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Attack on Titan
 */
class AttackOnTitanGallery {
    constructor() {
        // Lista de imagens do Attack on Titan
        this.images = [
            "https://i.ibb.co/TDR901Cm/AT-1.jpg",
            "https://i.ibb.co/1GbMcmN0/AT-2.jpg",
            "https://i.ibb.co/7MrYd0f/AT-3.jpg",
            "https://i.ibb.co/YrXMDJ0/AT-4.jpg",
            "https://i.ibb.co/My5vjsR1/AT-5.jpg",
            "https://i.ibb.co/1fgB1PHx/AT-6.jpg",
            "https://i.ibb.co/6R1CgVhj/AT-7.jpg",
            "https://i.ibb.co/rRdnpfz5/AT-8.jpg",
            "https://i.ibb.co/mVG4XsgS/AT-9.jpg",
            "https://i.ibb.co/svC5xfF6/AT-10.jpg",
            "https://i.ibb.co/Z6MzXV9K/AT-11.jpg",
            "https://i.ibb.co/Y4dTZj1j/AT-12.jpg",
            "https://i.ibb.co/fzxgbGsY/AT-13.jpg",
            "https://i.ibb.co/dwc8xCfm/AT-14.jpg",
            "https://i.ibb.co/22KQpxn/AT-15.jpg",
            "https://i.ibb.co/cSKLf66v/AT-16.jpg",
            "https://i.ibb.co/j9N55HXy/AT-17.jpg",
            "https://i.ibb.co/bMtRmX79/AT-18.jpg",
            "https://i.ibb.co/SXbkz5XR/AT-19.jpg",
            "https://i.ibb.co/sJsBvWTw/AT-20.jpg",
            "https://i.ibb.co/GQYptmpq/AT-21.jpg",
            "https://i.ibb.co/SzTw3gC/AT-23.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando AttackOnTitanGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando AttackOnTitanGallery...');
        ...
        console.log('AttackOnTitanGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Attack on Titan - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `⚔️ Olá! Quero esta placa do Attack on Titan (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO ATTACK ON TITAN
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('attackontitan.html')) {
        console.log('Página de gallery Attack on Titan detectada - inicializando...');
        const attackOnTitanGallery = new AttackOnTitanGallery();
    }
});