/**
 * SISTEMA NANATSU NO TAIZAI GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Nanatsu no Taizai
 */
class NanatsuNoTaizaiGallery {
    constructor() {
        // Lista de imagens do Nanatsu no Taizai
        this.images = [
            "https://i.ibb.co/CKFBhz59/1.jpg",
            "https://i.ibb.co/Wvx4TGcn/2.jpg",
            "https://i.ibb.co/sJWMH74h/3.jpg",
            "https://i.ibb.co/SwYy726v/4.jpg",
            "https://i.ibb.co/PZdwZjzg/5.jpg",
            "https://i.ibb.co/h1D5ZcDG/6.jpg",
            "https://i.ibb.co/Xf5HzPf7/7.jpg",
            "https://i.ibb.co/mrhmFCCG/8.jpg",
            "https://i.ibb.co/JjpyG5Lw/9.jpg",
            "https://i.ibb.co/W4nVKsQV/10.jpg",
            "https://i.ibb.co/v46cnzgq/11.jpg",
            "https://i.ibb.co/9kTXvDHZ/12.jpg",
            "https://i.ibb.co/Rpx55ZTR/13.jpg",
            "https://i.ibb.co/3yKMyKBs/14.jpg",
            "https://i.ibb.co/xtgsgF7s/15.jpg",
            "https://i.ibb.co/8DvYJC9f/16.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando NanatsuNoTaizaiGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando NanatsuNoTaizaiGallery...');
        ...
        console.log('NanatsuNoTaizaiGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Nanatsu no Taizai - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `⚔️ Olá! Quero esta placa do Nanatsu no Taizai (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO NANATSU NO TAIZAI
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('nanatsunotaizai.html')) {
        console.log('Página de gallery Nanatsu no Taizai detectada - inicializando...');
        const nanatsuNoTaizaiGallery = new NanatsuNoTaizaiGallery();
    }
});