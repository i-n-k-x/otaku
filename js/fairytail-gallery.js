/**
 * SISTEMA FAIRY TAIL GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Fairy Tail
 */
class FairyTailGallery {
    constructor() {
        // Lista de imagens do Fairy Tail
        this.images = [
            "https://i.ibb.co/nq4gt3Lp/F-1.jpg",
            "https://i.ibb.co/zWZGSDBS/F-2.jpg",
            "https://i.ibb.co/spbmXS2V/F-3.jpg",
            "https://i.ibb.co/cSBzd3C1/F-4.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando FairyTailGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando FairyTailGallery...');
        ...
        console.log('FairyTailGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Fairy Tail - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🧚 Olá! Quero esta placa do Fairy Tail (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO FAIRY TAIL
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('fairytail.html')) {
        console.log('Página de gallery Fairy Tail detectada - inicializando...');
        const fairyTailGallery = new FairyTailGallery();
    }
});
