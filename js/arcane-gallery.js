/**
 * SISTEMA ARCANE GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para a série Arcane
 */
class ArcaneGallery {
    constructor() {
        // Lista de imagens do Arcane
        this.images = [
            "https://i.ibb.co/LXn3WLdg/01.jpg",
            "https://i.ibb.co/fYPngKM9/02.jpg",
            "https://i.ibb.co/hFryZtpj/03.jpg",
            "https://i.ibb.co/VpzL8CmW/04.jpg",
            "https://i.ibb.co/JW9qY9QV/05.jpg",
            "https://i.ibb.co/fVWNNckX/06.jpg",
            "https://i.ibb.co/SwHfZp70/07.jpg",
            "https://i.ibb.co/9HGnpYNr/08.jpg",
            "https://i.ibb.co/57TK8kr/09.jpg",
            "https://i.ibb.co/ZpmFNCDn/10.jpg",
            "https://i.ibb.co/1GWkNfbJ/11.jpg",
            "https://i.ibb.co/WNs7QGF5/V-1.jpg",
            "https://i.ibb.co/1fg2Yr63/V-2.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando ArcaneGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando ArcaneGallery...');
        ...
        console.log('ArcaneGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Arcane - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🔮 Olá! Quero esta placa do Arcane (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO ARCANE
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('arcane.html')) {
        console.log('Página de gallery Arcane detectada - inicializando...');
        const arcaneGallery = new ArcaneGallery();
    }
});