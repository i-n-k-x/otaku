/**
 * SISTEMA SOLO LEVELING GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Solo Leveling
 */
class SoloLevelingGallery {
    constructor() {
        // Lista de imagens do Solo Leveling
        this.images = [
            "https://i.ibb.co/YFxf6ZC8/1.jpg",
            "https://i.ibb.co/tMcDwhdd/2.jpg",
            "https://i.ibb.co/Z1S7GkQL/3.jpg",
            "https://i.ibb.co/PsL7BnLb/4.jpg",
            "https://i.ibb.co/M56fY7PW/5.jpg",
            "https://i.ibb.co/kgXs07Bv/6.jpg",
            "https://i.ibb.co/kgy7yBsj/7.jpg",
            "https://i.ibb.co/R4NmpCrP/8.jpg",
            "https://i.ibb.co/JFd06bVD/9.jpg",
            "https://i.ibb.co/prZKJKQ0/10.jpg",
            "https://i.ibb.co/ccj1HC85/11.jpg",
            "https://i.ibb.co/xtCgZCSh/12.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando SoloLevelingGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando SoloLevelingGallery...');
        ...
        console.log('SoloLevelingGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Solo Leveling - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🗡️ Olá! Quero esta placa do Solo Leveling (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO SOLO LEVELING
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('sololeveling.html')) {
        console.log('Página de gallery Solo Leveling detectada - inicializando...');
        const soloLevelingGallery = new SoloLevelingGallery();
    }
});